...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x5479662B, 0x6AE4, 0x49e8, {0xA6, 0xBD, 0x6D, 0xE4, 0xB6, 0x25, 0x81, 0x1F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "KeyboardDxe";
...
{
  return InitializeBiosKeyboard (ImageHandle, SystemTable);
}
