...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAEA1FB0A, 0x8D5B, 0x4733, {0x8D, 0x4C, 0x72, 0x91, 0xD8, 0x3C, 0xE2, 0x9E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AudioDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiHdaControllerInfoProtocolGuid = { 0xE5FC2CAF, 0x0291, 0x46F2, { 0x87, 0xF8, 0x10, 0xC7, 0x58, 0x72, 0x58, 0x04 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiHdaIoProtocolGuid = { 0xA090D7F9, 0xB50A, 0x4EA1, { 0xBD, 0xE9, 0x1A, 0xA5, 0xE9, 0x81, 0x2F, 0x45 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiHdaCodecInfoProtocolGuid = { 0x6C9CDDE1, 0xE8A5, 0x43E5, { 0xBE, 0x88, 0xDA, 0x15, 0xBC, 0x1C, 0x02, 0x50 }};
...
#define _PCD_TOKEN_PcdSpinLockTimeout  40U
...
#define _PCD_TOKEN_PcdUefiFileHandleLibPrintBufferSize  115U
...
{
  return AudioDxeInit (ImageHandle, SystemTable);
}
