...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4ACA697E, 0xF883, 0x446f, {0x98, 0xF7, 0x09, 0x64, 0x16, 0xFF, 0xFF, 0xFF}};
...
{
  return OHCIDriverEntryPoint (ImageHandle, SystemTable);
}
