...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gApplePlatformInfoKeyboardGuid = {0x51871CB9, 0xE25D, 0x44B4, {0x96, 0x99, 0x0E, 0xE8, 0x64, 0x4C, 0xED, 0x69}};
...
#define _PCD_TOKEN_PcdUsbTransferTimeoutValue  100U
