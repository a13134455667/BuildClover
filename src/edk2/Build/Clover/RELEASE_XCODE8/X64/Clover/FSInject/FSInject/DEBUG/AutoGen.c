...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xFE089410, 0x6D31, 0x11E1, {0x8D, 0x6E, 0x96, 0xC2, 0x48, 0x24, 0x01, 0x9B}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FSInject";
...
{
  return FSInjectEntrypoint (ImageHandle, SystemTable);
}
