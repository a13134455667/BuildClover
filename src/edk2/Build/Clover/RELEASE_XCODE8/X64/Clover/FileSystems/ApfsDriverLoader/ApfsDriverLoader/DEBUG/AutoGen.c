...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBA6ED98D, 0xD133, 0x4F5B, {0x87, 0x87, 0xD2, 0x46, 0x4B, 0xB2, 0x11, 0x22}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ApfsDriverLoader";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gApplePartitionInfoProtocolGuid = {0x68425EE5, 0x1C43, 0x4BAA, {0x84, 0xF7, 0x9A, 0xA8, 0xA4, 0xD8, 0xE1, 0x1E}};
...
{
  return ApfsDriverLoaderInit (ImageHandle, SystemTable);
}
