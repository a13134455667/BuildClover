...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xEE593365, 0x0635, 0x44FC, {0xAF, 0x28, 0xDB, 0x98, 0xB6, 0x3F, 0xDB, 0xC6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GrubHFSPLUS";
...
{
  return FSDriverInstall (ImageHandle, SystemTable);
}
