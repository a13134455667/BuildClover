...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x80FB68D4, 0x7C52, 0x4AFE, {0xA9, 0x1E, 0xD3, 0xDD, 0xAD, 0xB5, 0xC5, 0x4F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GrubNTFS";
