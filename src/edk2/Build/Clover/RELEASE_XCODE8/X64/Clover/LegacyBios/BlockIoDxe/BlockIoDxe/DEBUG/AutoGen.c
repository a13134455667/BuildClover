...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4495E47E, 0x42A9, 0x4007, {0x8c, 0x17, 0xB6, 0x66, 0x4F, 0x90, 0x9D, 0x04}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BiosBlockIoDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gBlockIoVendorGuid = { 0xcf31fac5, 0xc24e, 0x11d2,  {0x85, 0xf3, 0x0, 0xa0, 0xc9, 0x3e, 0xc9, 0x3b }};
...
{
  return BiosBlockIoDriverEntryPoint (ImageHandle, SystemTable);
}
