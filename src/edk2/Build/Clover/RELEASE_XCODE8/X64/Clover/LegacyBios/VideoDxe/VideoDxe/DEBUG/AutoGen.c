...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0B04B2ED, 0x861C, 0x42cd, {0xA2, 0x2F, 0xC3, 0xAA, 0xFA, 0xCC, 0xB8, 0x96}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CsmVideoDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiLegacyBiosGuid = { 0x2E3044AC, 0x879F, 0x490F, { 0x97, 0x60, 0xBB, 0xDF, 0xAF, 0x69, 0x5F, 0x50 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdBiosVideoSetTextVgaModeEnable = _PCD_VALUE_PcdBiosVideoSetTextVgaModeEnable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdBiosVideoCheckVbeEnable = _PCD_VALUE_PcdBiosVideoCheckVbeEnable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdBiosVideoCheckVgaEnable = _PCD_VALUE_PcdBiosVideoCheckVgaEnable;
...
#define _PCD_TOKEN_PcdMaximumDevicePathNodeCount  15U
...
#define _PCD_TOKEN_PcdDriverDiagnosticsDisable  16U
...
#define _PCD_TOKEN_PcdComponentNameDisable  17U
...
#define _PCD_TOKEN_PcdDriverDiagnostics2Disable  18U
...
#define _PCD_TOKEN_PcdComponentName2Disable  19U
...
#define _PCD_TOKEN_PcdUefiLibMaxPrintBufferSize  21U
...
{
  return BiosVideoEntryPoint (ImageHandle, SystemTable);
}
