...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x43C8CFCA, 0x03C0, 0x4AA8, {0x8B, 0xEB, 0x5A, 0xF6, 0xAB, 0x35, 0x70, 0xA3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OsxAptioFix3Drv";
...
{
  return OsxAptioFixDrvEntrypoint (ImageHandle, SystemTable);
}
