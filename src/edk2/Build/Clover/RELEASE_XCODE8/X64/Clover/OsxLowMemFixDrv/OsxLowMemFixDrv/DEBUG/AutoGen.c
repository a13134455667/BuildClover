...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x5c3173bf, 0x28af, 0x4c10, {0xb2, 0x88, 0x1f, 0xdf, 0xf4, 0xc8, 0xb2, 0x13}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OsxLowMemFixDrv";
...
{
  return OsxLowMemFixDrvEntrypoint (ImageHandle, SystemTable);
}
