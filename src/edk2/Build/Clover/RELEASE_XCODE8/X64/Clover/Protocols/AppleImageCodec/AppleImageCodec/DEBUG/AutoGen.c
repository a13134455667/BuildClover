...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x259739d0, 0x6c81, 0x43d6, {0xbf, 0x5e, 0xe3, 0x2a, 0x65, 0x9c, 0x34, 0xf9}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AppleImageCodec";
...
{
  return AppleImageCodecEntrypoint (ImageHandle, SystemTable);
}
