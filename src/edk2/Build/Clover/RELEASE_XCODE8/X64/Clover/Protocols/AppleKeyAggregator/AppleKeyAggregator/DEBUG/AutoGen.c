...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAC4CE557, 0xF5CD, 0x439E, {0x96, 0x3C, 0x40, 0xF0, 0x96, 0x83, 0xDA, 0xC5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AppleKeyAggregator";
...
{
  return AggregatorEntryPoint (ImageHandle, SystemTable);
}
