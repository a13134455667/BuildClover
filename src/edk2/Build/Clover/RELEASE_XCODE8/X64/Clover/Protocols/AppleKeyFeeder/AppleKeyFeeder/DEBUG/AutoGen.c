...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4b67e98e, 0x996b, 0x40ba, {0xa7, 0x18, 0xae, 0x33, 0x19, 0x3e, 0xc5, 0xbe}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AppleKeyFeeder";
...
{
  return AppleKeyFeederEntrypoint (ImageHandle, SystemTable);
}
