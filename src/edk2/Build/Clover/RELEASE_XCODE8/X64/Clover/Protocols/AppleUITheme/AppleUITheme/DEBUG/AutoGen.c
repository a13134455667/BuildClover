...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x511CE688, 0x2893, 0x4398, {0xBB, 0x31, 0x81, 0x32, 0x43, 0xE4, 0x96, 0x96}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AppleUITheme";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAppleUserInterfaceThemeProtocolGuid = {0xD5B0AC65, 0x9A2D, 0x4D2A, {0xBB, 0xD6, 0xE8, 0x71, 0xA9, 0x5E, 0x04, 0x35}};
...
{
  return UserInterfaceThemeEntryPoint (ImageHandle, SystemTable);
}
