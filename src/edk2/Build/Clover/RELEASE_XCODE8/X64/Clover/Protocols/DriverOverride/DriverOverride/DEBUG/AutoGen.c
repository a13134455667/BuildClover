...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x511CE6DD, 0xF27F, 0x16EF, {0x86, 0x6C, 0xFD, 0xF2, 0x01, 0x45, 0x50, 0xB7}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DriverOverride";
...
{
  return DriverOverrideEntrypoint (ImageHandle, SystemTable);
}
