...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB7F22AE1, 0x9D87, 0x4CD6, {0x8E, 0xB1, 0x17, 0x15, 0x73, 0x90, 0x88, 0x35}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DumpUefiCalls";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAppleSMCProtocolGuid = {0x17407e5a, 0xaf6c, 0x4ee8, {0x98, 0xa8, 0x00, 0x21, 0x04, 0x53, 0xcd, 0xd9}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAppleKeyStateProtocolGuid = {0x5B213447, 0x6E73, 0x4901, {0xA4, 0xF1, 0xB8, 0x64, 0xF3, 0xB7, 0xA1, 0x72}};
...
{
  return DumpUefiCallsEntrypoint (ImageHandle, SystemTable);
}
