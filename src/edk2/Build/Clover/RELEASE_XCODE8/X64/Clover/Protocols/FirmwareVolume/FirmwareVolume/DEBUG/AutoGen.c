...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x511CE682, 0x2892, 0x4397, {0xBB, 0x31, 0x81, 0x32, 0x43, 0xE4, 0xCA, 0xD3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FirmwareVolume";
...
{
  return FVEntrypoint (ImageHandle, SystemTable);
}
