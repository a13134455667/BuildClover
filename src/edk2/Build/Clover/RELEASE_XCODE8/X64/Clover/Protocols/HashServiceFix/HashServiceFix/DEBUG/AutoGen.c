...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4C3B37B7, 0x08F8, 0x46AF, {0xB5, 0x85, 0x8C, 0x6B, 0x27, 0xE0, 0x0C, 0xCA}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HashServiceFix";
...
{
  return HSEntryPoint (ImageHandle, SystemTable);
}
