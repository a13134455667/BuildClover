...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x511CE6CE, 0xF27F, 0x16EF, {0x86, 0x6C, 0xFD, 0xF1, 0x01, 0x95, 0x50, 0xB7}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MsgLog";
...
{
  return MsgLogEntrypoint (ImageHandle, SystemTable);
}
