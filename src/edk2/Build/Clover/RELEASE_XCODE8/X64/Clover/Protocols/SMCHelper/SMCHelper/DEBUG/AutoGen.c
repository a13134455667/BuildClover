...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x511CE5CF, 0xF27F, 0x16EF, {0x86, 0x6C, 0xFA, 0xCE, 0x51, 0x95, 0x50, 0xB7}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SMCHelper";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAppleSMCStateProtocolGuid = {0x5301FE59, 0x1770, 0x4166, {0xA1, 0x69, 0x00, 0xC4, 0xBD, 0xE4, 0xA1, 0x62}};
...
{
  return SMCHelperEntrypoint (ImageHandle, SystemTable);
}
