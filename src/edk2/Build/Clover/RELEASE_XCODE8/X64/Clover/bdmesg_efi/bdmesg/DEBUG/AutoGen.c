...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9D666E87, 0x34FE, 0x44A7, {0xB9, 0x4C, 0x4B, 0x29, 0xD4, 0xF7, 0x47, 0xFB}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "bdmesg";
...
#define _PCD_TOKEN_PcdShellLibAutoInitialize  116U
...
#define _PCD_TOKEN_PcdShellPrintBufferSize  117U
...
{
  return BdmesgMain (ImageHandle, SystemTable);
}
