...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8F7D7B1E, 0x0E1C, 0x4C98, {0xB1, 0x2E, 0x4E, 0xC9, 0x9C, 0x40, 0x81, 0xAC}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CLOVER";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID AppleDevicePropertyProtocolGuid = {0x91BD12FE, 0xF6C3, 0x44FB, {0xA5, 0xB7, 0x51, 0x22, 0xAB, 0x30, 0x3A, 0xE0}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAppleScreenInfoProtocolGuid = {0xE316E100, 0x0751, 0x4C49, {0x90, 0x56, 0x48, 0x6C, 0x7E, 0x47, 0x29, 0x03}};
...
{
  return RefitMain (ImageHandle, SystemTable);
}
