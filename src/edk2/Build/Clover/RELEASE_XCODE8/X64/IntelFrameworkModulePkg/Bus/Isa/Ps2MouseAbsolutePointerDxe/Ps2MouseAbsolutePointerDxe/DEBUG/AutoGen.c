...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2899C94A, 0x1FB6, 0x4b1a, {0xB9, 0x6B, 0x83, 0x64, 0x97, 0x53, 0x03, 0xE0}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Ps2MouseAbsolutePointerDxe";
...
{
  return InitializePs2MouseAbsolutePointer (ImageHandle, SystemTable);
}
